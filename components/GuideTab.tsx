...
const sections = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: '기존 시간표에서 시수 가져오기',
        lines: [
          '이전에 만든 시간표의 구글 시트 URL을 입력하면 과목별 시수를 자동으로 읽어옵니다.',
          '워크시트가 여러 개인 경우 목록이 표시되며, 원하는 시트를 선택해 불러올 수 있습니다.',
          '불러온 시수를 바탕으로 수정 후 저장하면 새 커리큘럼으로 등록됩니다.',
        ],
      },
      {
        step: '저장된 커리큘럼 편집',
